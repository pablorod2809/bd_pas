...
class Entity implements EntityInterface, InvalidPropertyInterface
{
    ...
    // Funcion que permite dar formato a cualquier fecha desde cualquier lugar del framework
    ...
    // Funcion que permite crear y dar formato a una fecha a partir de un string
    public function formatStringDate($date = null)
    {
        if(!is_null($date))
